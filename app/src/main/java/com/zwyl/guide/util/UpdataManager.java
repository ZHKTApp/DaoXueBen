...
public class UpdataManager {
    ...
    public void getVersion() {
        ApiUtil.doDefaultApi(api.selectAppUpdate(appId), new HttpSucess<UpdataBean>() {
            @Override
            public void onSucess(UpdataBean data) {
...
//    }
    ...
    private class DownloadTask extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... url) {
            ...
            final String fileName = Constant.PACKAGE_NAME + "_V" + newVersion + ".apk";
